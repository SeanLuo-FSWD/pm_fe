    ...
    <div className={`${styles.textModule}`}>
      ...
      <Element name="sec1" className="element">
        ...
        <p>
          ...
          years ago, China was the wealthiest country on earth, with a GDP
          accounting for a quarter of the world. But behind its wealthy facade
          hides a dark secret: 90% of the Chinese are illiterate peasants. The
          ruling 10% elite have made sure that no peasants are able to read or
          write, by making the Chinese writing too difficult and time consuming
          to learn. Unlike English, or any Romanized language, Chinese
          characters have no connections between how it is written, and how it
          is read. To become literate, one must memorize the writing and then
          the pronunciations of hundreds of characters with no discernible
        ...
        <p>
          ...
          tend to focus on fixing the symptoms of this issue, such as rising
          crime rates, homelessness, or housing prices, but not the issue
          itself. For those who try to tackle wealth inequality directly, their
          solutions are often aimed to even out wealth distribution through
          policies that help the poor. This is also a non-solution, as it
          doesn’t correct the mechanism within capitalism that always leads back
          to the same problem.&nbsp;
        </p>
        <p>
          <br />
      ...
      <Element name="sec2" className="element">
        ...
        <p>
          ...
          that the rich deserve their wealth because they work harder or
          smarter. If you are taxing them at a higher rate, aren’t you
          discouraging hard work and innovation?&nbsp;
        </p>
        <p>
          ...
          the eventuality of its flawed mechanism, this becomes an addictive
        ...
        <p>
          ...
          unemployment compared to the previous generations.&nbsp;
        </p>
        <p>
          <br />
        </p>
        ...
        <p>
          ...
          form of exploitation given that he is only pay enough to keep working.
          And if you happen to be invested in this company which keeps growing
          as result of such, your wealth would be made by indirectly exploiting
          others.
        </p>
        <p>
          <br />
        ...
        <p>
          ...
          century, as it continues towards its equilibrium state.&nbsp;
        </p>
      </Element>
      <p>
        <br />
